import 'package:admin_fujika_ecommerce/core/constant/app.dart';
import 'package:admin_fujika_ecommerce/core/functions/fcmconfig.dart';
...
class LocaleController extends GetxController {
  ...
  requestPerLocation() async {
    ...
    //8 serviceEnabled = await Geolocator.isLocationServiceEnabled();
    //8 if (!serviceEnabled) {
